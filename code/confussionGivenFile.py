...
def runFeatureReduce() :
	...
	for i in range (0,int(sys.argv[1])):
		...
		dfLabels = read_csv("../data/results/"+"test"+str(i)+"_2500_12_196_148_21.txt", header=None)
		y_test=dfLabels.as_matrix().ravel()
		
		dfLabels = read_csv("../data/results/"+"results"+str(i)+"_2500_12_196_148_21.txt", header=None)
